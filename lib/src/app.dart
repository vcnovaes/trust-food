...
class TrustFoodApp extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ref.listen(SharedProviders.apiRepositoryProvider, (previous, next) {
      _apiStateListener(ref: ref, next: next, previous: previous, context: context);
    });
    final ThemeData themeData = ref.watch<ThemeData>(SharedProviders.themeNotifierProvider);
